...
grep -iE '(licensed under|spdx-license-identifier|mit license|bsd license|apache license|isc license|mozilla public license|permission is hereby granted|redistribution and use in source|all rights reserved)' added_lines > license_lines
